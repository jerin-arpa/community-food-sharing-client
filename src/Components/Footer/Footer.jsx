...
const Footer = () => {
    return (
        <div>
            <footer className="py-10 bg-base-200 text-base-content">
                <div>
                    <div className="footer flex flex-col md:flex-col lg:flex-row justify-between py-10 container mx-auto px-5">
                        ...
                        <nav>
                            <header className="text-lg text-[#23ad0e] font-extrabold mb-4">Services</header>
                        ...
                        <nav>
                            <header className="text-lg text-[#23ad0e] font-extrabold mb-4">Company</header>
                        ...
                        <nav>
                            <header className="text-lg text-[#23ad0e] font-extrabold mb-4">Social Links</header>
                            ...
                            <div>
                                <header className="text-lg text-[#23ad0e] font-extrabold mt-4">Address</header>
                                <h2>Sylhet Bangladesh</h2>
                            </div>
                        </nav>
                        <div>
                            <header className="text-lg text-[#23ad0e] font-extrabold mb-4">Contact</header>
                            <div className="my-1">
            ...
            <div className='bg-[#23ad0e] text-white py-5'>
