            ...
            user ? <>
                ...
                <li>
                    <NavLink to='/availableFoods' className={({ isActive, isPending }) =>
                        isPending ? "pending" : isActive ? "font-bold underline text-[#23ad0e]" : ""
                            ...
                            user ?
                                <div className="flex gap-2 md:gap-4">
                                        ...
                                        <div className="dropdown-content z-[2] menu p-2 shadow rounded-box lg:w-96 bg-white">
                                            <div className="p-3">
                                                ...
                                                <div className="text-center">
                                                    <h2 className="text-sm md:text-xl mb-2"><span className="text-[#23ad0e]">Name:</span> {user.displayName
                                                    }</h2>
                                                    <p className="text-sm  md:text-lg mb-5 "><span className="text-[#23ad0e]">Email:</span> {user.email}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <Link to='/login' className="flex items-center">
                                        <button onClick={handleSignOut} className="bg-[#23ad0e] border-0 text-white p-2 rounded-lg"><LuLogOut></LuLogOut></button>
                                    </Link>
                                </div>
                                :
                                <>
                                    <Link to='/login'>
                                        <button className="bg-[#23ad0e] border-0 text-white p-2 md:p-3 px-1 md:px-4 rounded-lg text-sm md:text-xl">Login</button>
                                    </Link>
                                </>
                        }
                    </div>
