                ...
                <div>
                    <div>
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 1, delay: 0.4 }}
                        >
                            <h1 className="mb-5 text-3xl lg:text-6xl font-bold text-center">WHO <span className='text-[#23ad0e]'>WE</span> ARE</h1>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 20 }}
                            animate={{ opacity: 1, x: 0 }}
                ...
                <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-14">
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.4 }}
                            >
                                <p className="my-5 text-3xl font-bold"><span className=" text-[#23ad0e]">Building Bridges</span> Through Food</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.4 }}
                            >
                                <p className="my-5 text-3xl font-bold"><span className=" text-[#23ad0e]">Food Equity</span> and Sustainability</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        <motion.div
                            ...
                            transition={{ duration: 1, delay: 0.4 }}
                            className="flex-1">
                            <img className="w-full" src={about3} alt="" />
                        </motion.div>
                        <div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                ...
                                transition={{ duration: 1, delay: 0.4 }}
                            >
                                <p className="my-5 text-3xl font-bold"><span className=" text-[#23ad0e]">Our Mission:</span> Nourishing Together</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        <motion.div
                            ...
                            transition={{ duration: 1, delay: 0.4 }}
                            className="flex-1">
                            <img className="w-full" src={about4} alt="" />
                        </motion.div>
                        <div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                                ...
                                transition={{ duration: 1, delay: 0.4 }}
                            >
                                <p className="my-5 text-3xl font-bold"><span className=" text-[#23ad0e]">Our Vision:</span> A Hunger-Free Tomorrow</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                                animate={{ opacity: 1, x: 0 }}
                ...
                <div className='container mx-auto px-5 py-28 flex flex-col lg:flex-row gap-10'>
                    <div className='flex-1'>
                        <div>
                            ...
                            >
                                <button className="btn bg-[#23ad0e] border-[#23ad0e] text-white hover:bg-white hover:text-[#23ad0e] hover:border-[#23ad0e] px-14">DONATE NOW</button>
                            </motion.div>
                        </div>
                    </div>
                </div>
