        ...
        <div>
            <div className="flex justify-center my-12 container mx-auto px-5 py-10">
                <div className="border rounded-xl w-full md:w-3/4 lg:w-2/4 py-8">
                    <h2 className="text-3xl font-bold text-center pt-10 pb-5"><span className='text-[#23ad0e]'>SignUp</span> <span className=''>your account</span></h2>
                    <form onSubmit={handleSignUp} className="px-4 md:px-14">
                        ...
                        <div>
                            {
                                success && <p className="text-[#23ad0e] text-xl font-bold text-center">{success}</p>
                            }
                        </div>

                        <div className="form-control mt-6">
                            <button className="btn bg-[#23ad0e] border-[#23ad0e] hover:bg-white hover:text-[#23ad0e] text-white font-bold">Sign Up</button>
                        </div>
                        <div>
                            <button onClick={handleGoogleSignUp} className="btn bg-transparent border-[#23ad0e] mt-5 mb-4 w-full">
                    ...
                    <div className="flex justify-center mb-4">
                        <h2 className="text-xs md:text-lg mt-6 md:mt-8 mb-6">Already have an account? <Link to='/login' className="text-[#23ad0e] underline font-bold">Login</Link></h2>
                    </div>
                </div>
            </div>
        </div>
