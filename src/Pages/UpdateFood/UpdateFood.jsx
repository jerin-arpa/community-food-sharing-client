...
const UpdateFood = () => {
    ...
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Food Sharing | Manage Food | Update Food</title>
            </Helmet>
            ...
            <div className="container mx-auto px-5 mb-20">
                <div className="flex justify-center">
                    <form onSubmit={handleUpdateFood} className="w-full lg:w-2/3 mt-16 border p-10 pb-14 rounded-xl">
                        {/* Food Information */}
                            ...
                            <div className="w-full">
                                <div className="w-full">
                                    <div className="form-control">
                                        ...
                                        <input type="text" name="foodImage" defaultValue={foodImage} className="input input-bordered" required />
                                    </div>
                                </div>
                        ...
                        <div className="w-full">
                            <div className="form-control">
                                ...
                                <input type="text" name="donatorImage"
                                    defaultValue={donatorImage} className="input input-bordered" />
                            </div>
                        </div>
                        ...
                        <div>
                            <button className="btn bg-[#23ad0e] border-[#23ad0e] hover:bg-white hover:text-[#23ad0e] text-white font-bold w-full mt-8">Update Food</button>
                        </div>
                    </form>
                </div>
            </div>
