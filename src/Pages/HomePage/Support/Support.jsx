                ...
                <div className='container mx-auto px-5 py-28'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10'>
                        <div className='bg-white p-7'>
                            ...
                            <motion.div className='text-center text-2xl'>{rounded1}</motion.div>
                        </div>
                        ...
                        <div className='bg-white p-7'>
                            ...
                            <motion.div className='text-center text-2xl'>{rounded2}</motion.div>
                        </div>
                        ...
                        <div className='bg-white p-7'>
                            ...
                            <h2 className='font-bold text-center mt-5'>Successful Projects</h2>
                            <motion.div className='text-center text-2xl'>{rounded3}</motion.div>
                        </div>
                        ...
                        <div className='bg-white p-7'>
                            ...
                            <h2 className='font-bold text-center mt-5'>Total Amount Raised</h2>
                            <motion.div className='text-center text-2xl'>{rounded4}</motion.div>
                        </div>
                    </div>
                </div>
            </div>
